...
class Touchdown:
    ...
    @staticmethod
    def fromDict(obj: Any) -> 'Touchdown':
        ...
        latitude = Helper.fromFloat(obj.get("Latitude", 0))
        longitude = Helper.fromFloat(obj.get("Longitude", 0))
        ...
        on_station = Helper.fromBool(obj.get("OnStation", False))
        on_planet = Helper.fromBool(obj.get("OnPlanet", False))
        return Touchdown(timestamp, event, player_controlled, latitude, longitude, nearest_destination, nearest_destination_localised, star_system, system_address, body, body_id, on_station, on_planet)
